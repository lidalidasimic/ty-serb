    ...
    <div className="mx-auto max-w-[640px] text-[17px] leading-7 text-ink">
      ...
      <Block number={6} title="Рассказываю о себе" active={currentStep === 6}>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <button onClick={() => setCurrentStep(5)} className="focus-ring min-h-12 rounded-xl border-2 border-ink bg-white px-5 py-3 font-black shadow-[3px_3px_0_#202124]">← Вернуться</button>
          <button onClick={() => showProfilePage("school")} className="focus-ring min-h-12 rounded-xl border-2 border-ink bg-serbian-red px-5 py-3 font-black text-white shadow-[3px_3px_0_#202124]">Дальше: школьная лексика →</button>
        </div>
        </> : null}
